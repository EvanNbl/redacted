...
interface CountryMultiSelectProps {
  selected: string[]; // Liste des pays sélectionnés
  onChange: (selected: string[]) => void;
  options: string[]; // Liste des pays disponibles
  placeholder?: string;
  id?: string;
  className?: string;
}
...
/**
 * Composant de sélection multiple de pays avec recherche.
 * Affiche les pays sélectionnés comme des tags et permet de rechercher/filtrer.
 */
